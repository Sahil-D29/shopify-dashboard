        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm font-medium text-[#4A4139]">
                Full Name
              </Label>
            ...
            {/* Email Field */}
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-medium text-[#4A4139]">
                Email Address
              </Label>
              <div className="relative">
            ...
            {/* Password Field */}
            <div className="space-y-2">
              <Label htmlFor="password" className="text-sm font-medium text-[#4A4139]">
                Password
              </Label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-sm font-medium text-[#4A4139]">
                Confirm Password
              </Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold shadow-md transition-all duration-200 disabled:opacity-50"
            >
              ...
              <>
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    className="w-full h-11 border-gray-200 hover:bg-gray-50 text-gray-700 font-medium shadow-sm"
                  >
                    {googleLoading ? (

    ...
    async function initEditor() {
      ...
      editor.setComponents(`<mjml>
        <mj-body background-color="#f4f4f4">
          <mj-section background-color="#1e293b" padding="30px 40px">
            <mj-column>
          ...
          <mj-section background-color="#ffffff" padding="40px">
            <mj-column>
              ...
              <mj-button background-color="#3b82f6" color="#ffffff" font-size="16px" font-weight="600" border-radius="6px" href="{{shop_url}}">
                Call to Action
              </mj-button>
            </mj-column>
          </mj-section>

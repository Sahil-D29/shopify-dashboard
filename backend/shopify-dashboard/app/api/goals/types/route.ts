...
const GOAL_TYPES = [
  ...
  },
  {
    type: 'shopify_event',
    label: 'Shopify Event',
    description: 'User performs a specific Shopify action',
    icon: 'shopping-cart',
    requiresEventSelection: true,
  },
  {
    type: 'whatsapp_engagement',
    label: 'WhatsApp Engagement',
    description: 'User engages with WhatsApp message',
    icon: 'message-circle',
  },
  {
    type: 'custom_event',
    label: 'Custom Event',
    description: 'Track any custom event',
    icon: 'zap',
    requiresEventName: true,
  },
  {
    type: 'segment_entry',
    label: 'Segment Entry',
    description: 'User enters a specific segment',
    icon: 'users',
    requiresSegmentSelection: true,
  },
];

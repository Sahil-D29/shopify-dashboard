...
export function AdvancedWhatsAppSettings({
  ...
  const handleRateLimitingChange = (rateLimiting: WhatsAppActionConfig['rateLimiting']) => {
    onConfigChange({ rateLimiting });
  };

  const handleFailureHandlingChange = (failureHandling: WhatsAppActionConfig['failureHandling']) => {
    onConfigChange({ failureHandling });
  };
                    ...
                    {selectedTemplate ? (
                      <div className="min-w-0">
                        <WhatsAppMessageEditor
                          ...
                          onBodyFieldChange={onBodyFieldChange}

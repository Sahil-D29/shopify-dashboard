      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Checkbox
              checked={failureHandling.maxRetries > 0}
              onCheckedChange={(checked) => onFailureHandlingChange('maxRetries', checked ? 2 : 0)}
            />
          </div>
        </CardHeader>
        {failureHandling.maxRetries > 0 && (
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                min="1"
                max="5"
                value={failureHandling.maxRetries}
                onChange={(e) => onFailureHandlingChange('maxRetries', parseInt(e.target.value) || 1)}
              />
            </div>

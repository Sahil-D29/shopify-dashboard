...
export function AddGoalModal({ isOpen, onClose, onSave }: AddGoalModalProps) {
  ...
  const handleSave = () => {
    ...
    if (selectedGoalType?.requiresSegmentSelection && (!form.filters || !form.filters.segmentId)) {
      return;
    }
    onSave(form);
    onClose();
      ...
      case "whatsapp_engagement":
        return (
          <div className="space-y-2">
            ...
            <Select
              value={form.filters?.engagementType ?? ""}
              onValueChange={value => setForm(prev => ({ ...prev, filters: { ...prev.filters, engagementType: value } }))}
            >
              <SelectTrigger>
      ...
      case "segment_entry":
        return (
          <div className="space-y-2">
            ...
            />
            <Select
              value={form.filters?.segmentId ?? ""}
              onValueChange={value => setForm(prev => ({ ...prev, filters: { ...prev.filters, segmentId: value } }))}
            >
              <SelectTrigger>
  ...
  const disableSave =
    ...
    (selectedGoalType?.requiresSegmentSelection && (!form.filters || !form.filters.segmentId));
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            value={(form.filters && form.filters.notes) || ""}
            onChange={event =>
              setForm(prev => ({
                ...prev,
                filters: { ...(prev.filters ?? {}), notes: event.target.value },
              }))
            }

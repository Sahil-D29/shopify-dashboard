export const SIDEBAR_CATALOG = [
  ...
  },
  {
    ...
    parentKey: 'settings',
    href: '/settings',
    routePrefixes: ['/settings?tab=shopify'],
  },
  {
    ...
    routePrefixes: ['/settings/whatsapp'],
  },
  {
    key: 'settings_team',
    label: 'Settings - Team',
    ...
    routePrefixes: ['/settings/team'],
  },
  {
    key: 'settings_custom_events',
    label: 'Settings - Custom Events',
    group: 'settings',
    parentKey: 'settings',
    href: '/settings?section=custom-events',
    routePrefixes: ['/settings/custom-events'],
  },
  {
    ...
    routePrefixes: ['/settings/api-keys'],
  },
  {
    ...
    routePrefixes: ['/settings/webhooks'],
  },
  {
    key: 'billing',
    label: 'Billing',

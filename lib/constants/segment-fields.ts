...
export const SEGMENT_FIELD_OPTIONS: SegmentFieldOption[] = [
  ...
  { value: 'event_subscription_created', label: 'Subscription Created', type: 'boolean', group: 'Shopify Events', status: 'requires_app' },
  { value: 'event_subscription_renewed', label: 'Subscription Renewed', type: 'boolean', group: 'Shopify Events', status: 'requires_app' },
  { value: 'event_subscription_cancelled', label: 'Subscription Cancelled', type: 'boolean', group: 'Shopify Events', status: 'requires_app' },
];
